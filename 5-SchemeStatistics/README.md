...
```
* find_top_contracts_per_month.py - finds the most used contracts by number of transactions for each month in 2020
* interesting_list.py - splits out transaction data for the top contracts per month into separate files
